...
class ChainzhixunSpider(Spider):
    name = 'chainzhixun'
    ...
    def parse(self, response):
        ...
        headers = {'Accept': 'image/webp,image/apng,image/*,*/*;q=0.8',
                   ...
                   'Referer': 'https://china.huanqiu.com/',
                   }

        for ll in url:
            urls_list = 'http://china.huanqiu.com/' + ll
    ...
    def start_parse(self, response):
        ...
        item['china_title'] = response.xpath("//div[@class='t-container-title']//text()").extract()
        item['china_content'] = response.xpath("//section//p//text()").extract()
        print("*" * 66)
        print("蜘蛛二完成下载")
        print("*" * 66)
        yield item